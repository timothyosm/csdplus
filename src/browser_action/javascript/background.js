function submit() {
  ...
  function injectTheScript() {
    chrome.tabs.executeScript(null, { file: "src/browser_action/Messages/noreply.js" });
  }
  function injectTheScript1() {
    chrome.tabs.executeScript(null, { file: "src/browser_action/Messages/call.js" });
  }
  function injectTheScript2() {
    chrome.tabs.executeScript(null, { file: "src/browser_action/Messages/db.js" });
  }
  function injectTheScript3() {
    chrome.tabs.executeScript(null, { file: "src/browser_action/Messages/dev.js" });
  }
  function injectTheScript4() {
    chrome.tabs.executeScript(null, { file: "src/browser_action/Messages/initial.js" });
  }

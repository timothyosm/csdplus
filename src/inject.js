      ...
      if (
        ...
        for (i = 0; i < tableCount; i++) {
          ...
          if (seconds > 604800 && !ticketCount.includes("With Customer")) {
            document
              .querySelector("#NewGadget5-listBody")
              .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
                "listBodyCell"
              )[9].style.backgroundColor = "#b19cd9";
          }
        }
      }
    }
        ...
        for (i = 0; i < tableCount; i++) {
          ...
          if (seconds > 604800) {
            document
              ...
              .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
                "listBodyCell"
              )[17].style.backgroundColor = "#b19cd9";
          }
        }
      }
    }
        ...
        for (i = 0; i < tableCount; i++) {
          ...
          if (seconds > 604800) {
            document
              ...
              .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
                "listBodyCell"
              )[8].style.backgroundColor = "#b19cd9";
          }
        }
      }
    }
        ...
        for (i = 0; i < tableCount; i++) {
          ...
          if (seconds > 1814400 && ticketCount.includes("With Customer")) {
            document
              ...
              .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
                "listBodyCell"
              )[9].style.backgroundColor = "#77dd77";
          }
        }
      }
    }
      ...
      if (
        ...
        for (i = 0; i < tableCount; i++) {
          ...
          if (document
            ...
            .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
              "listBodyCell"
            )[10].innerText == "End User") {
            document
              .querySelector("#NewGadget5-listBody")
              .getElementsByClassName("listBodyRow")[i].getElementsByClassName(
                "listBodyCell"
              )[10].style.backgroundColor = "#ffd1dc";
          }
        }
      }
    }
